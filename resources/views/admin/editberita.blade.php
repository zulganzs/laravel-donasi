...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500 mt-1">Perbarui informasi berita campaign.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-6">
        ...
        <form method="POST" action="/admin/campaign/berita/post-edit-berita" enctype="multipart/form-data">
            @csrf
            @foreach ($berita as $item)
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul" value="{{ $item->judul_berita }}" placeholder="Judul Berita" class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 outline-none transition-all">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Isi Berita</label>
                        <textarea id="editor" name="isi" class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-500 outline-none transition-all">{{ $item->isi_berita }}</textarea>
                    </div>
