                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-vertical" method="POST"
                                    action="/admin/campaign/berita/post-edit-berita" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul"
                                                            placeholder="Judul" value="{{ $item->judul_berita }}" />
                                                    </div>
                                                </div>
                                                <input type="hidden" name="id" value="{{ $item->id }}" />
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="isi-vertical">Isi Berita</label>
                                                        <textarea type="text" id="editor" class="form-control" name="isi">{{ $item->isi_berita }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
