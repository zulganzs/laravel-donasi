                        ...
                        <div class="card-content">
                            <div class="card-body">
                                @if (count($errors) > 0)
                                    ...
                                    @endforeach
                                @endif
                                <form class="form form-vertical" method="POST" action="/admin/post-edit-artikel"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="judul"
                                                            placeholder="Judul" value="{{ $item->judul_blog }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="editor" class="form-control" name="isi">{{ $item->isi_blog }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
